...
{
    [DbContext(typeof(ETicaretApıDbContext))]
    [Migration("20221029082915_tryingmig_2")]
    partial class tryingmig_2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.DenemeTablosu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.Property<DateTime?>("RefresTokemEndDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Identity.AppUserRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.Identity.AppUserRole", null)
                        .WithMany()
